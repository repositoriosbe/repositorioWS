...
public class Oser {
	 ...
	 * @param to
	 */
	public Oser(final OserTO to) {
		if (to != null) {
			this.eevvNmrSerie = to.getEevvNmrSerie();
			this.eevvNmrId = to.getEevvNmrId();
			this.fechaCreacionOs = to.getFechaCreacionOs();
			this.ctacteEmba = to.getCtacteEmba();
			this.nombreCtacte = to.getNombreCtacte();
			this.centroCosto = to.getCentroCosto();
			...
			this.codigoServComple = to.getCodigoServComple();
			this.cntpiezas = to.getCntpiezas();
			this.pesofisico = to.getPesofisico();
			this.pesovolumen = to.getPesovolumen();
			this.montoCOD = to.getMontoCOD();
			this.vlorimptopp = to.getVlorimptopp();
			this.vlorimptocc = to.getVlorimptocc();
			this.vlorfletepp = to.getVlorfletepp();
			this.vlorfletecc = to.getVlorfletecc();
			this.vlorvalorapp = to.getVlorvalorapp();
			this.vlorvaloracc = to.getVlorvaloracc();
			this.vlorvariospp = to.getVlorvariospp();
			this.vlorvarioscc = to.getVlorvarioscc();
			this.vlorseguro = to.getVlorseguro();
			this.vlordeclarado = to.getVlordeclarado();
			this.vloraduana = to.getVloraduana();
			...
			this.codigoEstadoDcbt = to.getCodigoEstadoDcbt();
		}
	}
