...
public class DatosCliente implements Serializable {
	 ...
	 * Constructor.
	 * 
	 * @param {@link DatosClienteTO datosTO}
	 */
	public DatosCliente(final DatosClienteTO datosTO) {
		if (datosTO != null) {
			this.rut = datosTO.getRut();
			this.digitoVerificador = datosTO.getDigitoVerificador();
			this.nombre = datosTO.getNombre();
			this.codigoRegion = datosTO.getCodigoRegion();
			this.ciudad = datosTO.getCiudad();
			this.calle = datosTO.getCalle();
			this.codigoComuna = datosTO.getCodigoComuna();
			this.comuna = datosTO.getComuna();
			this.numero = datosTO.getNumero();
			this.depto = datosTO.getDepto();
			this.block = datosTO.getBlock();
			this.piso = datosTO.getPiso();
			this.direccion = datosTO.getDireccion();
			this.codigoPostal = datosTO.getCodigoPostal();
			this.prefijoFono = datosTO.getPrefijoFono();
			this.fono = datosTO.getFono();
			this.extensionFono = datosTO.getExtensionFono();
			this.swtValorado = datosTO.getSwtValorado();
			this.swtCtaGratis = datosTO.getSwtCtaGratis();
		}
	}
