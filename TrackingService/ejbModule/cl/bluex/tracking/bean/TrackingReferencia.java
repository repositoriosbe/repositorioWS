...
@XmlType(name = "trackingReferencia",
		propOrder = {
		"fechaCreacion",
		"numeroGuia",
		"codPostaOrigen",
		...
		"codigoReferencia",
		"codigoPiezas",
		"fechaMovimientoPiezas",
		"codigoCargaTipoExcep",
		"descCargaTipoExcep",
		"codigoCargaTipoEvento",
		"descCargaTipoEvento",
		"codigoCargaPersonalizacion",
		"cantidadPiezasMovimiento",
		"pesoPiezasMovimiento",
		"observPiezasMovimiento"
		})
public class TrackingReferencia {
	 ...
	 * crea instancia de TrackingReferencia
	 *
	 * @param to {@link TrackingReferenciaTO}
	 */
	public TrackingReferencia(final TrackingReferenciaTO to) {
		if (to != null) {
			this.fechaCreacion = to.getFechaCreacion();
			this.numeroGuia = to.getNumeroGuia();
			this.codPostaOrigen = to.getCodPostaOrigen();
			this.descPostaOrigen = to.getDescPostaOrigen();
			this.codPostaDestino = to.getCodPostaDestino();
			this.descPostaDestino = to.getDescPostaDestino();
			this.codigoProducto = to.getCodigoProducto();
			this.nombreProducto = to.getNombreProducto();
			this.codigoTipoServicio = to.getCodigoTipoServicio();
			this.descTipoServicio = to.getDescTipoServicio();
			this.codigoReferencia = to.getCodigoReferencia();
			this.codigoPiezas = to.getCodigoPiezas();
			this.fechaMovimientoPiezas = to.getFechaMovimientoPiezas();
			this.codigoCargaTipoExcep = to.getCodigoCargaTipoExcep();
			this.descCargaTipoExcep = to.getDescCargaTipoExcep();
			this.codigoCargaTipoEvento = to.getCodigoCargaTipoEvento();
			this.descCargaTipoEvento = to.getDescCargaTipoEvento();
			this.codigoCargaPersonalizacion = to.getCodigoCargaPersonalizacion();
			this.cantidadPiezasMovimiento = to.getCantidadPiezasMovimiento();
			this.pesoPiezasMovimiento = to.getPesoPiezasMovimiento();
			this.observPiezasMovimiento = to.getObservPiezasMovimiento();
		}
	}
